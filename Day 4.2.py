...
for i in range(len(data)):
    if (data[i] == ""):
        passports.append(data[last:i])
        last = i
passports.append(data[last:])
...
reqData = ["byr","iyr","eyr","hgt","hcl","ecl","pid"]
for i in passports:
    if len(i) >= 7:
        points = 0
        for k in reqData:
        ...
        if points == 7:
            ...
            for k in range(len(i)):
                ...
                passData = i[k][4:]
                if dataTag == "byr":
                    if int(passData) < 1920 or int(passData) > 2002:
                        valid = False
                elif dataTag == "iyr":
                    if int(passData) < 2010 or int(passData) > 2020:
                        valid = False
                elif dataTag == "eyr":
                    if int(passData) < 2020 or int(passData) > 2030:
                        valid = False
                elif dataTag == "hgt":
                    if passData.find("cm") == -1:
                        if passData.find("in") == -1:
                            valid = False
                        else:
                            num = int(passData[:-2])
                            if num < 59 or num > 76:
                    ...
                    if len(passData) != 7:
                        ...
                        if passData[0] != "#":
                            ...
                            if not re.match(r"[^a-f^0-9]",passData):
                                valid = False
                elif dataTag == "ecl":
                    if len(passData) != 3:
                        valid = False
                    else:
                        if not re.match(r"amb|blu|brn|gry|grn|hzl|oth", passData):
                            valid = False
                elif dataTag == "pid":
                    if len(passData) != 9:
                        valid = False
                    else:
                        if re.match(r"[^0-9]", passData):
                            valid = False
            if valid:
                validPass += 1
            else:
